...
public class QuickAction3D extends PopupWindows implements OnDismissListener {
	...
	public QuickAction3D(Context context, int orientation) {
		...
		if (mOrientation == HORIZONTAL) {
			setRootViewId(R.layout.qa3d_popup_h);
		} else {
			setRootViewId(R.layout.qa3d_popup_v);
		}
	...
	public void addActionItem(ActionItem action) {
		...
		if (mOrientation == HORIZONTAL) {
			container = mInflater
					.inflate(R.layout.qa3d_item_h, null);
		} else {
			container = mInflater.inflate(R.layout.qa3d_item_v, null);
		}
		...
		if (mOrientation == HORIZONTAL && mChildPos != 0) {
			View separator = mInflater.inflate(R.layout.qa3d_seperator_h, null);
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickAction3D source, int pos,
				int actionId);
	}
